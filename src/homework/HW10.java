...
public class HW10 {
    ...
    //10
    public static boolean task10_IsWordStartsAndEndsOnSameLetter(String str) {
        //str.substring(0,1); firstLetter
        // str.substring(str.length() - 1); lastLetter
        ...
        public static void main (String[]arg){
            ...
            /**10.
             * Напишите метод, который принимает на вход слово, и возвращает true, если слово начинается и заканчивается на
            ...
            System.out.println(task10_IsWordStartsAndEndsOnSameLetter(str1));
            System.out.println(task10_IsWordStartsAndEndsOnSameLetter(str2));
            System.out.println(task10_IsWordStartsAndEndsOnSameLetter(str4)); //empty
            System.out.println(task10_IsWordStartsAndEndsOnSameLetter(str3)); //null
